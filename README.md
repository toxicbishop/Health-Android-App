...
When repeatedly signing up new users during testing, you may encounter a Supabase *Email Rate Limit*. To bypass this, simply navigate to your Supabase Project Settings -> Auth -> Rate Limits, and temporarily increase the limits, or use the "Log In" functionality with pre-created accounts directly from your Supabase Dashboard.

## 🤝 Developed By
An Advanced Agentic Coding Assistant
